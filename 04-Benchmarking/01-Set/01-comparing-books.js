...
console.log(
  "intersectionArr: ",
  intersectionArr(fantasyBooksArray, actionBooksArray),
);
...
export const isDisjointFromArr = (arr1, arr2) =>
  arr1.every((book) => !arr2.includes(book));
console.log(
  "isDisjointFromArr: ",
  isDisjointFromArr(fantasyBooksArray, actionBooksArray),
);
...
export const isSubsetOfArr = (arr1, arr2) =>
  arr1.every((book) => arr2.includes(book));
console.log(
  "isSubsetOfArr: ",
  isSubsetOfArr(fantasyBooksArray, actionBooksArray),
);
...
export const isSupersetOfArr = (arr1, arr2) =>
  arr2.every((book) => arr1.includes(book));
console.log(
  "isSupersetOfArr: ",
  isSupersetOfArr(fantasyBooksArray, actionBooksArray),
);
